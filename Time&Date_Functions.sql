...
-- 6.CURTIME([fsp])/CURRENT_TIME()/CURRENT_TIME: RETURNS CURRENT TIME AS A VALUE IN 'hh:mm:ss' FORMAT IF THE FUNCTION IS USED IN STRING CONTEXT,
  ...
  -- 7.NOW([fsp])/CURRENT_TIMESTAMP()/CURRENT_TIMESTAMP: RETURNS CURRENT DATE AND TIME AS A VALUE IN 'YYYY-MM-DD hh:mm:ss' FORMAT IF THE FUNCTION IS USED IN STRING CONTEXT,
...
SELECT TIMESTAMPDIFF(day,'2020-01-01 19:00:52','2020-01-01 18:15:34');
